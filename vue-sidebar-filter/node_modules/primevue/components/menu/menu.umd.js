...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('transition',{attrs:{"name":"p-input-overlay"},on:{"enter":_vm.onEnter,"leave":_vm.onLeave}},[(_vm.popup ? _vm.visible : true)?_c('div',{ref:"container",class:_vm.containerClass},[_c('ul',{staticClass:"p-menu-list p-reset",attrs:{"role":"menu"}},[_vm._l((_vm.model),function(item,i){return [(item.items && item.visible !== false)?[(item.items)?_c('li',{key:item.label+i,staticClass:"p-submenu-header"},[_vm._v(_vm._s(item.label))]):_vm._e(),_vm._l((item.items),function(child,j){return _c('Menuitem',{key:child.label+i+j,attrs:{"item":child},on:{"click":_vm.itemClick}})})]:[_c('Menuitem',{key:item.label+i,attrs:{"item":item},on:{"click":_vm.itemClick}})]]})],2)]):_vm._e()])}
var staticRenderFns = []

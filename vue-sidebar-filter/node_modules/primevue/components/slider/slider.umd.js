...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Slider_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// load the styles
var content = __webpack_require__("07ed");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("024940b5", content, true, {"sourceMap":false,"shadowMode":false});
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"2ec0fcfe-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/slider/Slider.vue?vue&type=template&id=441702e8&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"container",class:_vm.containerClass,on:{"click":_vm.onBarClick}},[_c('span',{staticClass:"p-slider-range",style:(_vm.rangeStyle)}),(!_vm.range)?_c('span',{staticClass:"p-slider-handle",style:(_vm.handleStyle),attrs:{"tabindex":"0","role":"slider","aria-valuemin":_vm.min,"aria-valuenow":"value","aria-valuemax":"max","aria-labelledby":_vm.ariaLabelledBy},on:{"mousedown":function($event){return _vm.onHandleMouseDown($event)},"keydown":function($event){return _vm.onHandleKeyDown($event)}}}):_vm._e(),(_vm.range)?_c('span',{staticClass:"p-slider-handle",style:(_vm.rangeStartHandleStyle),attrs:{"tabindex":"0","role":"slider","aria-valuemin":_vm.min,"aria-valuenow":"value ? value[0] : null","aria-valuemax":"max","aria-labelledby":_vm.ariaLabelledBy},on:{"mousedown":function($event){return _vm.onHandleMouseDown($event, 0)},"keydown":function($event){return _vm.onHandleKeyDown($event, 0)}}}):_vm._e(),(_vm.range)?_c('span',{staticClass:"p-slider-handle",style:(_vm.rangeEndHandleStyle),attrs:{"tabindex":"0","role":"slider","aria-valuemin":_vm.min,"aria-valuenow":"value = value[1] : null","aria-valuemax":"max","aria-labelledby":_vm.ariaLabelledBy},on:{"mousedown":function($event){return _vm.onHandleMouseDown($event, 1)},"keydown":function($event){return _vm.onHandleKeyDown($event, 1)}}}):_vm._e()])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/slider/Slider.vue?vue&type=template&id=441702e8&
...
/* harmony default export */ var Slidervue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    setValueFromHandlePosition: function setValueFromHandlePosition(event, handlePosition) {
      var newValue = (this.max - this.min) * (handlePosition / 100) + this.min;

      if (this.range) {
        if (this.step) this.handleStepChange(event, newValue, this.value[this.handleIndex]);else this.updateModel(event, newValue);
      } else {
        if (this.step) this.handleStepChange(event, newValue, this.value);else this.updateModel(event, newValue);
      }
    },
    onSlide: function onSlide(event) {
      var handlePosition = this.horizontal ? (event.pageX - this.initX) * 100 / this.barWidth : (this.initY + this.barHeight - event.pageY) * 100 / this.barHeight;
      this.setValueFromHandlePosition(event, handlePosition);
    },
    handleStepChange: function handleStepChange(event, newValue, oldValue) {
    ...
    updateModel: function updateModel(event, value) {
      ...
      if (this.range) {
        ...
        modelValue = _toConsumableArray(this.value);
    ...
    onHandleMouseDown: function onHandleMouseDown(event, index) {
      if (this.disabled) {
        return;
      }
    ...
    onHandleKeyDown: function onHandleKeyDown(event, index) {
      this.handleIndex = index;
  ...
  computed: {
    ...
    handlePosition: function handlePosition() {
      if (this.value === 0) return 0;else if (this.value < this.min) return 0;else if (this.value > this.max) return 100;else return (this.value - this.min) * 100 / (this.max - this.min);
    },
    rangeStartPosition: function rangeStartPosition() {
      if (this.value) return (this.value[0] < this.min ? 0 : this.value[0] - this.min) * 100 / (this.max - this.min);else return 0;
    },
    rangeEndPosition: function rangeEndPosition() {
      if (this.value) return (this.value[1] > this.max ? 100 : this.value[1] - this.min) * 100 / (this.max - this.min);else return 0;
    },
...
// EXTERNAL MODULE: ./src/components/slider/Slider.vue?vue&type=style&index=0&lang=css&
var Slidervue_type_style_index_0_lang_css_ = __webpack_require__("53b6");

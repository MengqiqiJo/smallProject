...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Carousel_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// module
exports.push([module.i, ".p-carousel{width:100%}.p-carousel,.p-carousel-content{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column}.p-carousel-content{-ms-flex-wrap:nowrap;flex-wrap:nowrap;overflow:auto;padding:0 .5em}.p-carousel-next,.p-carousel-prev{-ms-flex-item-align:center;align-self:center;text-align:center;-webkit-box-flex:0;-ms-flex-positive:0;flex-grow:0;-ms-flex-negative:0;flex-shrink:0;width:2.5em;height:2.5em}.p-carousel-next span,.p-carousel-prev span{width:100%;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center}.p-carousel-container{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-direction:row;flex-direction:row;padding:0 .1em}.p-carousel-items-content{overflow:hidden;width:100%}.p-carousel-footer,.p-carousel-header{padding:0 .5em;z-index:1}.p-carousel-items-container{display:-webkit-box;display:-ms-flexbox;display:flex;-ms-flex-wrap:nowrap;flex-wrap:nowrap;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-direction:row;flex-direction:row}.p-carousel-items-container .p-carousel-item{width:100%;-webkit-box-sizing:border-box;box-sizing:border-box;overflow:auto}.p-carousel .p-carousel-dots-container{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-direction:row;flex-direction:row;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-ms-flex-wrap:wrap;flex-wrap:wrap;margin:.5em}.p-carousel-vertical .p-carousel-container{width:100%}.p-carousel-vertical .p-carousel-container,.p-carousel-vertical .p-carousel-items-container{-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column}.p-carousel-vertical .p-carousel-items-container{height:100%}.p-carousel-vertical .p-carousel-dots-container{margin:.75em 0}.p-items-hidden .p-carousel-item{visibility:hidden}.p-items-hidden .p-carousel-item.p-carousel-item-active{visibility:visible}", ""]);
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{class:['p-carousel p-component', {'p-carousel-vertical': _vm.isVertical(), 'p-carousel-horizontal': !_vm.isVertical()}],attrs:{"id":_vm.id}},[(_vm.$scopedSlots.header)?_c('div',{staticClass:"p-carousel-header"},[_vm._t("header")],2):_vm._e(),_c('div',{class:_vm.contentClasses},[_c('div',{class:_vm.containerClasses},[_c('button',{class:['p-carousel-prev p-button', {'p-disabled': _vm.backwardIsDisabled}],attrs:{"disabled":_vm.backwardIsDisabled,"type":"button"},on:{"click":_vm.navBackward}},[_c('span',{class:['p-carousel-prev-icon pi', {'pi-chevron-left': !_vm.isVertical(),'pi-chevron-up': _vm.isVertical()}]})]),_c('div',{staticClass:"p-carousel-items-content",style:([{'height': _vm.isVertical() ? _vm.verticalViewPortHeight : 'auto'}])},[_c('div',{ref:"itemsContainer",staticClass:"p-carousel-items-container",on:{"transitionend":_vm.onTransitionEnd,"touchend":_vm.onTouchEnd,"touchstart":_vm.onTouchStart,"touchmove":_vm.onTouchMove}},[(_vm.isCircular())?_vm._l((_vm.value.slice(-1 * _vm.d_numVisible)),function(item,index){return _c('div',{key:index + '_scloned',class:['p-carousel-item p-carousel-item-cloned',
						...
						'p-carousel-item-end': _vm.lastIndex() === index}]},[_vm._t("item",null,{"data":item,"index":index})],2)}),(_vm.isCircular())?_vm._l((_vm.value.slice(0, _vm.d_numVisible)),function(item,index){return _c('div',{key:index + '_fcloned',class:['p-carousel-item p-carousel-item-cloned',
							{'p-carousel-item-active': _vm.totalShiftedItems === 0,
							'p-carousel-item-start': 0 === index,
							'p-carousel-item-end': _vm.value.slice(0, _vm.d_numVisible).length - 1 === index}]},[_vm._t("item",null,{"data":item,"index":index})],2)}):_vm._e()],2)]),_c('button',{class:['p-carousel-next p-button', {'p-disabled': _vm.forwardIsDisabled}],attrs:{"disabled":_vm.forwardIsDisabled,"type":"button"},on:{"click":_vm.navForward}},[_c('span',{class:['p-carousel-prev-icon pi', {'pi-chevron-right': !_vm.isVertical(),'pi-chevron-down': _vm.isVertical()}]})])]),_c('ul',{class:_vm.dotsContentClasses},_vm._l((_vm.totalDots),function(totalDot,i){return _c('li',{key:'p-carousel-dot-' + i,class:['p-carousel-dot-item', {'p-highlight': _vm.d_page === i}]},[_c('button',{staticClass:"p-link",attrs:{"type":"button"},on:{"click":function($event){return _vm.onDotClick($event, i)}}},[_c('span',{class:['p-carousel-dot-icon pi', {'pi-circle-on': _vm.d_page === i, 'pi-circle-off': !(_vm.d_page === i)}]})])])}),0)]),(_vm.$scopedSlots.footer)?_c('div',{staticClass:"p-carousel-footer"},[_vm._t("footer")],2):_vm._e()])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/carousel/Carousel.vue?vue&type=template&id=1cbfa864&
...
/* harmony default export */ var Carouselvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    onDotClick: function onDotClick(e, index) {
      var page = this.d_page;
    ...
    startAutoplay: function startAutoplay() {
      ...
      this.interval = setInterval(function () {
        if (_this2.d_page === _this2.totalDots - 1) {
          _this2.step(-1, 0);
        } else {
  ...
  computed: {
    ...
    dotsContentClasses: function dotsContentClasses() {
...
var Carouselvue_type_style_index_0_lang_css_ = __webpack_require__("5487");

import { Injectable, Directive, ElementRef, Input, Output, HostListener, EventEmitter, NgZone, NgModule, defineInjectable } from '@angular/core';
...
/** @nocollapse */ NgxEchartsService.ngInjectableDef = defineInjectable({ factory: function NgxEchartsService_Factory() { return new NgxEchartsService(); }, token: NgxEchartsService, providedIn: "root" });
...
export { NgxEchartsService, NgxEchartsModule, NgxEchartsDirective as ɵa };

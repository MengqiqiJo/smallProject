  ...
  echo '<script type="text/javascript" src="http://cdnjs.cloudflare.com/ajax/libs/jspdf/0.9.6rc1/jspdf.min.js"></script>';
...
class page {
  ...
  public function certificatePage() {
    ...
    $output .= '<div class="margin-top-26">';
      $output .= '<div id="mycontent" class="container margin-top-26 margin-bottom-26 color-1F497C border-1F497C-solid-3px font-italic over-flow height-746 width-840" style="width:840px;">';
         ...
         $output .= '<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">';
           $output .= '<div class="row">';
            ...
            $output .= '<div class="margin-top-38 border-left-1F497C-solid-3px height-446">';
             ...
             $output .= 'The Multi-disciplinary';
               $output .= '<br />';
               $output .= 'Interstitial Lung';
               $output .= '<br />';
               $output .= 'Disease Discussions <br />
